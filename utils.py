...
# def get_hits_2(emb, emb2, test_align_nodes, all_align_nodes, top_k=(1, 5, 10, 30, 50)):
#     Lvec = np.array([emb[e1] for e1 in test_align_nodes])
#     Rvec = np.array([emb2[e2] for e2 in all_align_nodes])
#     print("test_pairs", len(test_align_nodes))
#     # sim = scipy.spatial.distance.cdist(Lvec, Rvec, metric='euclidean')
#     num = 0
#     sim = scipy.spatial.distance.cdist(Lvec, Rvec, metric='cityblock')
#     top_lr = [0] * len(top_k)
